...
const benefits = [
  ...
  },
  {
    ...
    description: 'Clear booking flow with no confusing steps.',
    icon: ReceiptText,
  },
  {
    title: 'Satisfaction Focused',
    description: 'Service updates and support through the platform.',
    icon: BadgeCheck,
  },
];
...
export function ServicesTrustStrip() {
  return (
    <section className="bg-[var(--sf-bg)] pb-12 sm:pb-16 lg:pb-24">
      <Container>
